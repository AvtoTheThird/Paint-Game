...
const EndOFGameScreen: React.FC<{
  ...
  // );
  return (
    <div className="flex justify-start items-center flex-col absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-white border-4 border-dark-pink w-[706px] h-[528px] rounded-[1rem]  gap-5 z-50 pinkBackground">
